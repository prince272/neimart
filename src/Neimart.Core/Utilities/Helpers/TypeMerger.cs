...
{
    // A simple convention-based object merger for .NET Core.
    // source: https://github.com/kfinley/TypeMerger
    /// <summary>
    ...
    public class TypeMergerPolicy
    {
        ...
        private readonly IList<Tuple<string, string>> ignoredProperties;
        private readonly IList<Tuple<string, string>> useProperties;
