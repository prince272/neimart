...
{
    // TODO: AuthorizeTagHelper should be changed to AuthenticateTagHelper.
    // But to avoid bugs during code changes we leave it unchanged.
    ...
    public class AuthorizeTagHelper : TagHelper, IAuthorizeData
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if ((!authorizeResult.Succeeded) == Authorize)
            {
